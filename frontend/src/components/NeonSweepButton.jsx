 ...
 * 🎨 THEME CONFIGURATION
 * --------------------------------------------------------------------------
 * Defines the color schemes for the NeonSweepButton. Each tone specifies 
 * the default state styles (border, bg, text) and the hover state styles.
 * ========================================================================== */
const toneClasses = {
  cyan: {
 ...
 * --------------------------------------------------------------------------
 * Standardized padding and text sizes for the buttons.
 * ========================================================================== */
const sizeClasses = {
 ...
 * sweeping background animation on hover. It accepts standard button
 * attributes alongside custom 'tone' and 'size' props.
 * ========================================================================== */
