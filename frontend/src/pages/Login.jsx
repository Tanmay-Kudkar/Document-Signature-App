    ...
    <div className="min-h-screen bg-[#f5f5fa] flex flex-col md:flex-row animate-page-fade">
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-12 md:p-20 bg-white">
        <div className="w-full max-w-md animate-slide-up delay-100 fill-mode-forwards opacity-0">
          ...
          <form className="space-y-5 animate-slide-up delay-200 fill-mode-forwards opacity-0">
            <div>
            ...
            <button 
              type="submit" 
              className="w-full bg-[#e5322d] text-white py-4 rounded-xl font-bold text-lg hover:bg-[#cc2b26] transition-all shadow-lg shadow-red-100 flex items-center justify-center gap-2 group transform active:scale-[0.98]"
            >
              Sign In
